...
<head>
    ...
    <title>EcoEscola - Gamificação Escolar</title>
...
<body class="bg-gray-50">
    ...
    <div id="notification" class="notification bg-green-500 text-white px-6 py-3 rounded-lg shadow-lg">
        <div class="flex items-center">
            <span id="notificationText">Missão concluída! +50 pontos</span>
    ...
    <div id="loginScreen" class="min-h-screen gradient-bg flex items-center justify-center p-4">
        <div class="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md">
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600">Gamificação para Preservação Escolar</p>
            </div>
    ...
    <div id="studentApp" class="hidden min-h-screen bg-gray-50">
                ...
                <div class="flex justify-between items-center h-16">
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="flex items-center bg-accent text-white px-3 py-1 rounded-full">
                            <span class="text-sm font-medium">⭐ <span id="userPoints">0</span> pontos</span>
                        </div>
                        
                        <div class="flex items-center bg-secondary text-white px-3 py-1 rounded-full">
                            <span class="text-sm font-medium">🔥 <span id="userStreak">0</span> dias</span>
                        </div>
        ...
        <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div id="missionsContent" class="tab-content">
                <div class="mb-8">
                    <h2 class="text-2xl font-bold text-gray-900 mb-2">Suas Missões</h2>
                    <p class="text-gray-600">Complete missões para ganhar pontos e medalhas!</p>
                </div>
            ...
            <div id="rankingContent" class="tab-content hidden">
                <div class="mb-8">
                    ...
                    <p class="text-gray-600">Veja quem são os guardiões da escola!</p>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-2">
                        <div class="bg-white rounded-lg shadow p-6 mb-6">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="text-sm text-gray-600">Missões Concluídas</div>
                                </div>
                                <div class="text-center">
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="text-sm text-gray-600">Posição</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-lg shadow p-6">
                            <h3 class="text-lg font-semibold text-gray-800 mb-4">Histórico Recente</h3>
                    ...
                    <div>
                        <div class="bg-white rounded-lg shadow p-6">
                            ...
                            <div class="grid grid-cols-2 gap-4" id="badges">
                                <!-- Medalhas serão carregadas aqui -->
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="rewardsContent" class="tab-content hidden">
                <div class="mb-8">
                    ...
                    <p class="text-gray-600">Troque seus pontos por prêmios incríveis!</p>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="rewardsList">
                    <!-- Recompensas serão carregadas aqui -->
                </div>
            </div>
        </main>
    </div>
        ...
        <div class="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
            <div class="p-6">
                <div class="flex justify-between items-start mb-4">
                    <h3 class="text-lg font-semibold text-gray-900" id="modalMissionTitle">Título da Missão</h3>
                ...
                <div class="mb-4">
                    <p class="text-gray-600" id="modalMissionDescription">Descrição da missão</p>
                ...
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-2">
                        Comprove que completou a missão:
                    </label>
                    <textarea id="missionProof" 
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                              rows="3" 
                              placeholder="Descreva como você completou a missão..."></textarea>
                </div>
                ...
                <form onsubmit="adminLogin(event)" class="space-y-4">
                    <div>
                        ...
                        <input type="password" id="adminCode" required 
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                               placeholder="Digite o código de professor">
                    </div>
    ...
    <script>
        ...
        const sampleMissions = [
            ...
            {
                id: 2,
                title: "Não rabisque mesas ou paredes",
                description: "Preserve o patrimônio escolar mantendo móveis e paredes limpos",
                type: "daily",
                points: 30,
                icon: "✏️"
            },
            {
                ...
                description: "Colabore com a organização dos livros na biblioteca",
                type: "weekly",
                points: 100,
                icon: "📚"
            },
            ...
            {
                id: 5,
                title: "Economize água nos bebedouros",
                description: "Use a água de forma consciente nos bebedouros da escola",
                type: "daily",
                points: 35,
                icon: "💧"
            },
            {
                id: 6,
                title: "Participe da limpeza do pátio",
                description: "Ajude a manter o pátio da escola limpo e organizado",
                type: "weekly",
                points: 80,
                icon: "🏫"
            },
        ...
        const badges = [
            { id: 1, name: "Guardião da Escola", icon: "🛡️", requirement: "Complete 10 missões" },
            { id: 2, name: "Amigo do Patrimônio", icon: "🏛️", requirement: "Complete 5 missões de preservação" },
            { id: 3, name: "Eco Warrior", icon: "🌱", requirement: "Complete 3 missões ambientais" },
            { id: 4, name: "Líder da Turma", icon: "👑", requirement: "Fique em 1º lugar no ranking" },
            { id: 5, name: "Persistente", icon: "🔥", requirement: "Mantenha streak de 7 dias" },
            { id: 6, name: "Colaborador", icon: "🤝", requirement: "Complete 5 missões em grupo" }
        ];

        // Funções do Supabase
        async function initializeSupabase() {
            // Se não há cliente Supabase configurado, usar dados locais
            if (!supabaseClient) {
            ...
            try {
                ...
                if (missionsError) {
                    console.log('Usando dados locais para missões:', missionsError);
                    appData.missions = [...sampleMissions];
                } else {
                ...
                // Se não há dados no Supabase, inserir dados de exemplo
        ...
        async function insertSampleData() {
            try {
                ...
                if (missionsError) console.log('Erro ao inserir missões:', missionsError);
        ...
        async function initializeApp() {
            ...
            if (savedUser) {
                ...
                // Tentar atualizar dados do usuário do Supabase
        ...
        async function login(event) {
            ...
            // Tentar carregar usuário do Supabase
        ...
        function createMissionCard(mission, isCompleted) {
            ...
            card.innerHTML = `
                ...
                <div class="flex justify-between items-center">
                    ...
                    ${isCompleted ? 
                        '<span class="bg-white bg-opacity-20 px-2 py-1 rounded text-xs">✓ Concluída</span>' : 
        ...
        async function completeMission() {
            ...
            if (!proof) {
                alert('Por favor, descreva como você completou a missão.');
                return;
            }
            
            showLoading();
            
            // Adicionar missão completada
            ...
            // Mostrar notificação
            showNotification(`Missão concluída! +${selectedMission.points} pontos`);
        ...
        function checkBadges() {
            ...
            // Guardião da Escola - 10 missões
            if (completedCount >= 10 && !currentUser.badges.includes(1)) {
                currentUser.badges.push(1);
                showNotification('Nova medalha: Guardião da Escola! 🛡️');
            }
            
            // Amigo do Patrimônio - 5 missões de preservação
            const preservationMissions = currentUser.completedMissions.filter(cm => {
                ...
                return mission && (mission.title.includes('limpa') || mission.title.includes('rabisque') || mission.title.includes('patrimônio'));
            });
            
            if (preservationMissions.length >= 5 && !currentUser.badges.includes(2)) {
                currentUser.badges.push(2);
                showNotification('Nova medalha: Amigo do Patrimônio! 🏛️');
            }
            
            // Persistente - streak de 7 dias
            if (currentUser.streak >= 7 && !currentUser.badges.includes(5)) {
                currentUser.badges.push(5);
                showNotification('Nova medalha: Persistente! 🔥');
            }
        }
            ...
            sortedUsers.forEach((user, index) => {
                ...
                item.innerHTML = `
                    ...
                    <div class="text-right">
                        ...
                        <div class="text-sm text-gray-500">${user.completedMissions.length} missões</div>
                    </div>
                `;
            ...
            sortedClasses.forEach((classData, index) => {
                ...
                item.innerHTML = `
                    ...
                    <div class="text-right">
                        ...
                        <div class="text-sm text-gray-500">Média: ${classData.avgPoints} pts</div>
                    </div>
                `;
        ...
        function createPodiumCard(user, position, bgClass) {
            ...
            card.innerHTML = `
                <div class="text-2xl mb-1">${position === 1 ? '🥇' : position === 2 ? '🥈' : '🥉'}</div>
        ...
        function loadProfile() {
            ...
            document.getElementById('profileRank').textContent = userRank + 'º';
            ...
            if (recentMissions.length === 0) {
                historyContainer.innerHTML = '<p class="text-gray-500 text-center py-4">Nenhuma missão concluída ainda</p>';
            }
        ...
        async function redeemReward(reward) {
            ...
            if (confirm(`Deseja resgatar "${reward.title}" por ${reward.cost} pontos?`)) {
                ...
                showNotification(`Recompensa resgatada: ${reward.title}! 🎉`);
                updateUserInfo();
                loadRewards();
            }
        }
        ...
        function adminLogin(event) {
            ...
            // Código simples para demo (em produção seria mais seguro)
            if (code === 'admin123') {
                alert('Funcionalidade de admin será implementada em breve!');
                closeAdminModal();
            } else {
